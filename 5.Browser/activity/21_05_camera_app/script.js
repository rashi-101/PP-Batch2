...
let mediaRecorder;
//when we'll have a mediaStream with us, we'll inititalise it by putting it equal to new MediaRecorder(mediastream), by this, we'll know that which stream are we going to record
...
//refer to steve griffin videos to get an into to varios apis and stuff
